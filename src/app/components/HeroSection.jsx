      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        ...
        >
          ...
          <p className='text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl'>
            A passionate web developer skilled in HTML, CSS, JavaScript, React
            js and Next.js. I love building clean, responsive, and user-friendly
            web applications.
          </p>
          <div>
            <Link
        ...
        >
          {/* <div className='rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative'>
            <Image
              ...
              alt='hero image'
              className='object-fit: cover absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2'
              width={300}
              height={300}
            />
          </div> */}
